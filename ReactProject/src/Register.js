...
export default class Register extends Component{
    ...
    onRegister(){
        ...
        fetch('http://ec2-18-191-227-95.us-east-2.compute.amazonaws.com:8080/Psych-1/', {
            method: 'POST',
            headers: {
		...
		return(
            <View style={outerContainer}>
                <View style={container}>
                    ...
                    <Picker
                        selectedValue={this.state.mobileExperience}
                        onValueChange={(itemValue, itemIndex) => this.setState({mobileExperience: itemValue})}>
                    ...
                    <MKTextField
                        text={this.state.medication}
                        onTextChange={medication => this.setState({medication})}
                        textInputStyle={fieldStyles}
                    ...
                    <CheckBox
                        ...
                        checked={this.state.colorBlindness}
                    />
                    <CheckBox
                        title='Disable'
                        checked={this.state.disabilityStatus}
                    />
                    <MKTextField
                        text={this.state.registrationCode}
                        onTextChange={registrationCode => this.setState({registrationCode})}
                        textInputStyle={fieldStyles}
